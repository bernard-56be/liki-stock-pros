        ...
        <Card className="border border-gray-100 bg-white/90 shadow-sm backdrop-blur-sm">
          <CardHeader className="flex flex-col gap-2 border-b border-gray-100/50 md:flex-row md:items-center md:justify-between">
            ...
            <p className="text-xs text-gray-500 mt-1">
              ...
              {activeTab === 'boutique' && 'Gérez les détails commerciaux et administratifs de votre établissement.'}
              {activeTab === 'password' && 'Assurez-vous d’utiliser un mot de passe robuste pour protéger votre accès.'}
            </p>
          </CardHeader>
          ...
          <CardContent className="space-y-4 pt-6">
            ...
            {activeTab === 'password' && (
              <form onSubmit={handleSubmit(updatePassword)} className="space-y-5 max-w-md">
                <div className="space-y-2">
                  <label htmlFor="newPassword" className="text-sm font-medium text-gray-600">Nouveau mot de passe</label>
                  <input
                    type="password"
                    id="newPassword"
                    name="newPassword"
